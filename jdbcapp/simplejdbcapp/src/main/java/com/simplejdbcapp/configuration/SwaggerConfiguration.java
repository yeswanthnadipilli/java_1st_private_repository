package com.simplejdbcapp.configuration;
...
public class SwaggerConfiguration {
    ...
    public Docket getDocket(){
        ...
        return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.simplejdbcapp")).build().apiInfo(apiInfo).useDefaultResponseMessages(false);

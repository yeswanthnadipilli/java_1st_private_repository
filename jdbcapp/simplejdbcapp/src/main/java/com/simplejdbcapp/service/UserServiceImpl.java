...
import com.simplejdbcapp.repository.DbRepository;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User createUsers(User user,QueryResponse res) {

        User user1 = repository.saveUser(res, user);
        return user1;
    }
    ...
    @Override
    public String deleteUser(int id,QueryResponse user) {
        repository.deleteById(id,user);
        return "Data Has Been Deleted By : "+id;
    }

    @Override
    public List<User> allUsers(QueryResponse res) {
        List<User> users = repository.findAll(res);
        return users;
    }

    @Override
    public User searchParticularUser(int id,QueryResponse res) {
        User user = repository.findById(id, res);
        return user;
    }
